...
ACPF.registerClass( 'InitState', 'com.asliceofcrazypie.three.states',
function( base )
{var AssetsLoader = ACPF.getClassByQualifiedName( 'com.asliceofcrazypie.fw.comms.AssetsLoader');var AGameState = ACPF.getClassByQualifiedName( 'com.asliceofcrazypie.three.AGameState');var EngineState = ACPF.getClassByQualifiedName( 'com.asliceofcrazypie.three.states.EngineState');
