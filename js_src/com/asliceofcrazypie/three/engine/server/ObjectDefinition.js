...
//#class com.asliceofcrazypie.three.engine.server.ObjectDefinition extends com.asliceofcrazypie.fw.Base
function( base ){
    ...
    this.constructor = function( name, definition, dynamicsWorld ){
